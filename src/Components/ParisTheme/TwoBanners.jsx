          ...
          {dataAPI?.main_content?.section6_two_column_banners?.banner_1?.redirect_link?.link_type === 'external_url' ? (
            <Link href={dataAPI?.main_content?.section6_two_column_banners?.banner_1?.redirect_link?.link || '/'} target='_blank'>
              <div className='banner-contain hover-effect'>
                <img src={"https://img.freepik.com/free-photo/delicious-chocolate-cake-stand-with-copy-space_23-2148834047.jpg?t=st=1724568922~exp=1724572522~hmac=0e881f495cc87c3ebb115b89f18dfc6a9a5021475ebd4bdf934df3a213d21a9d&w=1380"} className='img-fluid' alt='Organic Banner' height={245} width={1182} />
              </div>
            </Link>
            ...
            <div className='banner-contain hover-effect'>
              <Image src={"https://img.freepik.com/free-photo/delicious-chocolate-cake-stand-with-copy-space_23-2148834047.jpg?t=st=1724568922~exp=1724572522~hmac=0e881f495cc87c3ebb115b89f18dfc6a9a5021475ebd4bdf934df3a213d21a9d&w=1380"} className='img-fluid' alt='Organic Banner' height={245} width={1182} />
            </div>
          )}
        </Col>
        ...
        <Col xl={12} xxl={4} md={5}>
          {dataAPI?.main_content?.section6_two_column_banners?.banner_2?.redirect_link?.link_type === 'external_url' ? (
            <Link href={dataAPI?.main_content?.section6_two_column_banners?.banner_2?.redirect_link?.link || '/'} target='_blank' className='banner-contain hover-effect'>
              <Image src={"https://img.freepik.com/premium-photo/high-resolution-photo-delicious-slice-cheesecake-dropping-with-sugar-powder-bursting_1130039-677.jpg?semt=ais_hybrid"} className='img-fluid' alt='Diet Soda' height={245} width={378} />
            </Link>
            ...
            <Link href={`/${i18Lang}/collections?category=${dataAPI?.main_content?.section6_two_column_banners?.banner_2?.redirect_link?.link}` || '/'} className='banner-contain hover-effect'>
              <img src={"https://img.freepik.com/premium-photo/high-resolution-photo-delicious-slice-cheesecake-dropping-with-sugar-powder-bursting_1130039-677.jpg?semt=ais_hybrid"} className='img-fluid' alt='Diet Soda' height={245} width={378} />
            </Link>
